const FEEDS = [
  ...
  { url: 'https://news.google.com/rss/search?q=commodities+oil+gas+coal+copper+gold+supply+disruption+pipeline+LNG+OPEC+production+when:1d&hl=en-US&gl=US&ceid=US:en', label: 'Commodities' },
